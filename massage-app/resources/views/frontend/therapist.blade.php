...
<section class="mainView" id="scrollTopPoint">
  <div class="mainViewCont ts">
    ...
    <p><p>サンプルエステリンパでは、お客様一人ひとりにご満足いただけるよう、8時間以上の研修を経てデビューしたセラピストが在籍しております。<br />
癒しと安らぎ、そして全てを忘れ、2人きりの空間で、ごゆっくりおくつろぎください。</p>
</p>
</div>
    </div>
  </div>
...
<!-- ======== staffsView ======== -->
<section class="staffsView clearfix pdTop140 pdBottom140 m-pdTop50 m-pdBottom50">
  ...
  <div class="staffsViewCont cont">
    ...
    <div class="staffsList clearfix">

      <div class="item clearfix">
        <a  href="therapist/therapist_1.html">
          <div class="item_img">
            <img src="assets/customer/staff.png" />
          </div>
          <div class="itemInfo">
            <div class="mark">
                  <label>NEW</label>
